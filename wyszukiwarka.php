...
<html>
   ...
   <body class="light">
         ...
         <div class="container-fluid text-white">
            <div class="row p-t-b-10 ">
               <div class="col">
                  <h7>
                     <i class="icon-home"></i>
                     Strona Główna <i class="icon-angle-right"></i> Strefa Gracza <i class="icon-angle-right"></i> Wyszukiwarka
                  </h7>
               </div>
            </div>
         </div>
      ...
      <div class="container-fluid relative animatedParent animateOnce">
         ...
         <!-- // KONIEC GÓRNA CZĘŚĆ \\ -->
         <!-- // STATYSTKI - ZAKŁADKA \\ -->
		<form class="form-inline my-2 my-lg-0 action="wyszukiwarka.php" method="post">
		   <input style="width: 21em;" class="form-control mr-sm-2" name="login" type="text">
		   <input class="btn btn-outline-primary my-2 my-sm-0" type="submit" name="szukaj" value="Szukaj">
		</form>
		<?php
		include 'bazadanych.php';
		if (isset($_POST['szukaj']));
			$login = $_POST['login'];
			$zawartoscBaza = "SELECT * FROM `cG_uzytkownicy` WHERE `Login` = '$login'";
			$rezultatBaza = $polaczenieBaza->query($zawartoscBaza);
			foreach($rezultatBaza as $kolumnaBaza); {
			if ($kolumnaBaza == 0) {
		...
		echo'<div class="card shadow">
            <div class="p-3">
               ...
               <div>
                  <h6 class="p-t-10">brak informacji</h6>
                  Karta gracza
               </div>
            </div>
            <ul class="list-group list-group-flush">
			   <li class="list-group-item">
                  ...
                  <span class="badge badge-dark float-right r-3">brak informacji</span>
               </li>
               <li class="list-group-item">
